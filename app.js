...
// will be usefull for deployment
...
mongoose.connect('mongodb+srv://Nay:kun@cluster0.ipbns9i.mongodb.net/?retryWrites=true&w=majority', {
}).then(() => {
...
app.listen(process.env.PORT || 8000, function () { console.log('Votre app est disponible sur localhost:8000 !') })
